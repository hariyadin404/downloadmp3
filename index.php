...
<div id="main">
	...
	<h1 style="background-image:url('<?php echo $siteurl; ?>/img/bgmen.JPG'); background-repeat:repeat-x; font-size:19px; margin:0; padding-left:12px; padding-top:7px; padding-bottom:6px; border-bottom:1px solid #787878; color:#003250;">Top Downloads</h1>
<div style="text-align:left;">


<?php

$query = "SELECT `tag` FROM  `search` ORDER BY RAND() LIMIT 15";
...
$link = $siteurl."download.php?q=".$link;

echo '<div id="topsong"><div id="topleft">'.$id.'</div><div id="topright">';
...
?>
	...
	<div style="float:left; width:310px; margin-top:20px; text-align:center; margin-left:5px;">
	<b>Social Bookmarking!<b>
		
	</div>
	
	
	<div style="font-size:14px;float:left; width:300px; margin-left:10px; border:1px solid #ccc; border-top:3px solid #ccc; text-align:left; margin-top:20px;">
